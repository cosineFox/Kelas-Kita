...
const migrations = [
  ["001_initial", new URL("./schema.sql", import.meta.url)],
  ["002_flexible_study_period", new URL("./migrations/002_flexible_study_period.sql", import.meta.url)],
];
...
try {
  ...
  `);
  for (const [migrationId, url] of migrations) {
