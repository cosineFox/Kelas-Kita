...
test("applies the protected production schema and excludes pending ratings", async () => {
  ...
  await database.exec(await readFile(new URL("./migrations/002_flexible_study_period.sql", import.meta.url), "utf8"));
