...
export default function Turnstile({ onToken, resetKey = 0 }) {
  ...
  return <div className="turnstile-slot"><div ref={container} className="cf-turnstile" data-sitekey={siteKey} data-action={action} /><small>Cloudflare anti-bot check</small></div>;
}
